...
!function(d){var h=function(a){this.messages={defaultMessage:"Este valor parece ser inválido.",type:{email:"Este valor deve ser um e-mail válido.",url:"Este valor deve ser uma URL válida.",urlstrict:"Este valor deve ser uma URL válida.",number:"Este valor deve ser um número válido.",digits:"Este valor deveria ser dígitos.",dateIso:"Este valor deve ser uma data válida (AAAA- MM -DD).",alphanum:"Este valor deve ser alfanumérico.",phone:"Este valor deve ser um número de telefone válido."},notnull:"Este valor não deve ser nulo.", notblank:"Este valor não deve ficar em branco.",required:"Este valor é obrigatório",regexp:"Este valor parece ser inválido.",min:"Este valor deve ser maior do que ou igual a %s.",max:"Este valor deve ser inferior ou igual a %s.",range:"Este valor deve ser entre %s e %s.",minlength:"Este valor é muito curto. Ela deve ter %s caracteres ou mais",maxlength:"Este valor é muito longo. Ela deve ter %s caracteres ou menos.",rangelength:"Quantidade de caracteres inválida. Deve estar entre %s e %s caracteres.",
mincheck:"Você deve selecionar pelo menos %s opções.",maxcheck:"Você deve selecionar %s escolhas ou menos.",rangecheck:"Você deve selecionar entre %s e %s escolhas",equalto:"Esse valor deve ser o mesmo."};this.init(a)};h.prototype={constructor:h,validators:{notnull:function(a){return 0<a.length},notblank:function(a){return"string"===typeof a&&""!==a.replace(/^\s+/g,"").replace(/\s+$/g,"")},required:function(a){if("object"===typeof a){for(var b in a)if(this.required(a[b]))return!0;return!1}return this.notnull(a)&&
